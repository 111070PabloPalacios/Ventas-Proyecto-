...
namespace ABMProductos
{
    ...
    {
        accesoDatos datos = new accesoDatos(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\Pablo\Desktop\Escritorio\P\DBFProducto.mdb");
        const int tam = 30;
        ...
        public bool validar()
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("El codigo solo puede tener numeros.",
                        "Error",
            ...
            if (txtDetalle.Text == "")
            {
             ...
             if (txtDetalle.Text.Any(char.IsDigit))
                {
            ...
            if (validar())
            {
                ...
                if (nuevo)
                {
                    if (!existe(p.pCodigo))
                    {
                        ...
                        {
                        sql = "UPDATE producto SET detalle = '" + p.pDetalle + "' , tipo =" + p.pTipo +
                        ", marca = " + p.pMarca + ", precio = " + p.pPrecio + ", fecha = '" + p.pFecha +
